...
f=open('Lessons/FilePractFiles/file1.txt','r')
text=f.read()
print(text)
f.close()
...
# Writing into File
f=open('Lessons/FilePractFiles/file2.txt','w')
f.write("I am written using write method")
f=open('Lessons/FilePractFiles/file2.txt','r')
file2data=f.read()
print(file2data)
f.close()
...
# Append Mode 
print("Append Mode:: ")
f=open('Lessons/FilePractFiles/file2.txt','a')
f.write("\nI Written Using Append Mode ")
f=open('Lessons/FilePractFiles/file2.txt','r')
file2data=f.read()
print(file2data)
f.close()
...
with open('Lessons/FilePractFiles/file2.txt','r') as f:
    with_data=f.read()
    print(with_data)

# readline() Method- Use to read file content line by line

f=open('Lessons/FilePractFiles/file3.txt','r')
while True:
    line=f.readline()
    if not line:
        break
...
f= open('Lessons/FilePractFiles/file4.txt','w')
lines=['Line1 \n''Line2  \n''Line3 \n''Line4\n']
f.writelines(lines)
f.close()
f=open('Lessons/FilePractFiles/file4.txt','r')
text=f.read()
print(text)
f.close()

# seek() Function - allows to move the current position within a file to specific point
with open('Lessons/FilePractFiles/file4.txt','r') as f:
    f.seek(10)
    data=f.read(5)
    print(data)
...
with open('Lessons/FilePractFiles/file5.txt','w') as f:
    f.write("This Is Truncate Method")
    f.truncate(10)

with open('Lessons/FilePractFiles/file5.txt','r') as f:
    filedata=f.read()
    print(filedata)
    f.close()